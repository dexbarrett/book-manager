...
$(document).ready(function () {
  ...
  $('.autocomplete-live').each(function () {
    var url = Object(ziggy__WEBPACK_IMPORTED_MODULE_0__["default"])($(this).data('search-type'));
    $(this).select2({
      ajax: {
        url: url,
        dataType: 'json',
...
try {
  ...
  $.fn.select2.defaults.set('language', App.language);
} catch (e) {}
/**
...
var Ziggy = {
  namedRoutes: {
    ...
    "search_author": {
      "uri": "admin\/search\/author",
      "methods": ["GET", "HEAD"],
      "domain": null
    },
    "search_publisher": {
      "uri": "admin\/search\/publisher",
      "methods": ["GET", "HEAD"],
      "domain": null
    }
  },
  baseUrl: 'http://books.wip/',
  baseProtocol: 'http',
  baseDomain: 'books.wip',
  basePort: false,
  defaultParameters: []
};
...
__webpack_require__(/*! /home/vagrant/code/books/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/vagrant/code/books/resources/sass/app.scss */"./resources/sass/app.scss");
